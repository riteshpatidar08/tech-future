...
const features: CertificationFeature[] = [
  {
    ...
    description:
      'Certificates recognized by top tech companies and hiring managers worldwide',
  },
  {
    icon: <Shield className="h-6 w-6" />,
    title: 'Verification System',
    description:
      'Unique certificate ID for employers to verify authenticity online',
  },
  {
    icon: <Globe className="h-6 w-6" />,
    title: 'Global Validity',
    description:
      'Accepted and recognized internationally by employers and institutions',
  },
  {
    icon: <FileCheck className="h-6 w-6" />,
    title: 'LinkedIn Integration',
    description:
      'Easy to add to LinkedIn profile and share with your professional network',
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-10 left-10 opacity-10 hidden lg:block">
        <VectorIllustrations type="graduation" size={150} />
      </div>
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-base md:text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
            Earn a professional certificate upon course completion. Validate
        ...
        >
          {features.map((feature, idx) => (
            <Card
              key={idx}
              className="border-2 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 text-center"
            >
        ...
        <div className="mt-12 text-center">
          <p className="text-slate-600 mb-4">
            Complete any course to earn your certificate
          </p>
