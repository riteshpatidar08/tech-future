...
const CourseCard = ({ title, description, duration, students, rating, icon, features, gradient }: CourseCardProps) => {
  return (
    <div className="group relative bg-white/5 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-purple-500/20 hover:border-purple-500/40">
      {/* Gradient Background */}
